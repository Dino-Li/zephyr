...
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3STS, 0x20);
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3DO, 0x21);
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3DI, 0x22);
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3CTL, 0x23);
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3IC, 0x24);
IT8XXX2_REG_OFFSET_CHECK(pmc_regs, PM3IE, 0x25);
