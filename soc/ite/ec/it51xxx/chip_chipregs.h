 ...
 * 24-bit timers: external timer 3
 */
enum ext_timer_idx {
	EXT_TIMER_2 = 0, /* Event timer */
	EXT_TIMER_3,     /* Busy wait timer */
};
#endif /* __ASSEMBLER__ */

/* ETWD register fields */
/* 0x05: External Control */
#define IT51XXX_ETWD_ET3TC   BIT(7)
#define IT51XXX_ETWD_ET3RST  BIT(7)
#define IT51XXX_ETWD_ET2RST  BIT(2)
/* 0x21: External Timer Terminal count write clear */
#define IT51XXX_ETWD_ET3TCWC BIT(2)
